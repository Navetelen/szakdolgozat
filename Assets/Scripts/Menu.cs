...
public class Menu : MonoBehaviourPunCallbacks, ILobbyCallbacks
{
    ...
    //update room list cb function
    //photon sends on every join
    ...
    //called when back btn getss pressed
    ...
    {
        //enable the menu buttons on connecting to server
    ...
    //this gets called on all pc-s who are in the room
    ...
    void UpdateLobbyUI()
    {
        ...
        //each player in Photon has a Player class
